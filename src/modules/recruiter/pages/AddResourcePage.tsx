      ...
      <main className="page">
        <PageTransition>
          ...
          <div className="mx-auto max-w-3xl">
            ...
            <p className="mt-1 text-sm text-slate-500">{isEdit ? "Update this candidate's details." : 'Add a candidate. Only visible in your dashboard.'}</p>
            ...
            <motion.form initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }}
              ...
              <div className="mt-6">
                ...
                <p className="text-xs text-slate-400 mb-3">Upload PDF files. Clients and recruiters can view and download them.</p>
                  ...
                  {([['Resume','resume'],['Evaluation','evaluationReport'],['Background','backgroundReport']] as const).map(([label, key]) => (
                    <label key={key} className="cursor-pointer">
                      <div className={`flex flex-col items-center gap-2 rounded-xl border-2 border-dashed p-4 text-center transition
                        ...
                        <span className="max-w-full truncate text-xs text-slate-400">{docLabels[key] || 'Click to upload'}</span>
                      </div>
